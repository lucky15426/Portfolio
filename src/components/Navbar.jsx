    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          >
            <motion.div
              className={`text-2xl font-bold tracking-tight ${theme === 'dark' ? 'text-[#b8f2e6]' : 'text-[#5e6472]'
                }`}
            >
              Portfolio
            </motion.div>
            <motion.div
              className={`absolute -bottom-1 left-0 h-0.5 ${theme === 'dark' ? 'bg-[#b8f2e6]' : 'bg-[#aed9e0]'
                }`}
              initial={{ width: 0 }}
          ...
          <div className="hidden md:flex items-center space-x-8">
            {navItems.map((item, idx) => (
              <motion.a
                ...
                className="relative group"
              >
                <span className={`text-base font-medium transition-colors duration-200 ${theme === 'dark' ? 'text-[#b8f2e6]' : 'text-[#5e6472]'
                  }`}>
                  {item}
                </span>
                <motion.div
